...
const STATIONS = [
  ...
  {
    id:         'brainwave',
    label:      'Synphaera Radio',
    emoji:      '🌌',
    desc:       'Modern ambient & space music',
    color:      '#7C6CF2',
    gradient:   'linear-gradient(135deg, #1b2446, #2c3a6d)',
    stream:     'https://ice4.somafm.com/synphaera-128-mp3',
    tags:       ['Ambient', 'Focus', 'Deep Work'],
  ...
  {
    id:         'classiccafe',
    label:      'Groove Salad Classic',
    emoji:      '🎛️',
    desc:       'Classic downtempo & chilled grooves',
    color:      '#FBBF24',
    gradient:   'linear-gradient(135deg, #451a03, #713f12)',
    stream:     'https://ice4.somafm.com/gsclassic-128-mp3',
    tags:       ['Ambient', 'Classic', 'Study'],
